...
public class LoginActivity extends AppCompatActivity implements LoginOnResponse {
    ...
    private void loginUser() throws JSONException {
        ...
        JSONObject loginUserRequestBody = new JSONObject();
        // initialising the JSON object
        loginUserRequestBody.put(kEY_EMAIL, email.getText().toString()); // email of the user taken from the text field
        loginUserRequestBody.put(kEY_PASS, password.getText().toString()); // password of the user taken from the text field


        UserService userService = new UserService();
        userService.loginUser(loginUserRequestBody,this);
