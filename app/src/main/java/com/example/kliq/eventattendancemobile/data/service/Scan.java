    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder surfaceHolder) {
                try{
                    if (ContextCompat.checkSelfPermission(com.example.kliq.eventattendancemobile.data.service.Scan.this, Manifest.permission.CAMERA)== PackageManager.PERMISSION_GRANTED){
        ...
        barcode.setProcessor(new Detector.Processor<Barcode>() {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size()>0){
                    ...
                    Intent intent = new Intent(com.example.kliq.eventattendancemobile.data.service.Scan.this, ResultScreen.class);
